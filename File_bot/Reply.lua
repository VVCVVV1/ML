...
if text == 'مطور السورس' or text == 'مطور ستارك' then
TextReply = '[--> - LUCIFER . <--](t.me/BBLBB0)'
send(msg.chat_id_, msg.id_,'['..TextReply..']')
return false
end
if text == 'مبرمج ستارك' or text == 'مبرمج السورس' then
TextReply = '[--> LUCIFER <--](http://t.me/BBLBB0)'
send(msg.chat_id_, msg.id_,'['..TextReply..']')
return false
end
if text == 'منو المطور' or text == 'منو مطور' then
TextReply = '[--> - LUCIFER . <--](t.me/BBLBB0) حبيبي هذا مطور السورس '
send(msg.chat_id_, msg.id_,'['..TextReply..']')
return false
end
if text == 'هلو' then
